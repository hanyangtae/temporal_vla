...
## 7. 새 세션 프롬프트
"main checkout ~/pkt_ws/temporal_vla (branch feat/rs-steer-v4)에서 중추(전체 파이프) 세션 이어받아줘. 정본 = docs/collab/handoff_20260902_v4r_round.md. 게이팅 설계 = docs/steering/47. §1 판정 재론 x. §6-1(데이터 재수집)부터. 협업 세션은 ListAgents."
