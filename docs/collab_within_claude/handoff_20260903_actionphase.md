...
> **§7**(v6 기준으로 갱신됨)에 있다. **코드 경로·실행 커맨드·함정은 별도 문서**
> [`handoff_20260905_actionphase_toolchain.md`](handoff_20260905_actionphase_toolchain.md)
> 로 뺐다 — 이어받아 바로 돌려야 하면 그쪽을 먼저 본다. §1~§5 는 v5 시점 기술이라 좌표는 낡았지만 **구조
