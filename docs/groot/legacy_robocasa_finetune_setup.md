...
> Legacy note: 이 문서는 초기 fine-tuning runbook이다. 현재 N1.6 RoboCasa fine-tuning 기준 문서는 `docs/groot/n16_robocasa_finetune.md`다. 체크포인트 위치는 현재 repo 규칙에 맞춰 `outputs/checkpoints/GR00T-N1.6-3B`를 사용한다.
