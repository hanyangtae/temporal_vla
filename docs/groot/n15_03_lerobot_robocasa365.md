...
- **[3] robocasa365 eval** — official `robocasa/<Task>` split closed-loop rollout.
  ...
  [`n15_07`](n15_07_lerobot_internal_parity.md).
...
| [`n15_06`](n15_06_native_zmq_openfridge.md) | native Isaac-GR00T N1.5 ZMQ vs LeRobot HTTP behavior 비교 | evidence |
| [`n15_07`](n15_07_lerobot_internal_parity.md) | SR 외 checkpoint-load 검증과 historical internal evidence | evidence |
...
4. **LeRobot N1.5 checkpoint-load verifier** — ✅ retained parity script는
   [`n15_07`](n15_07_lerobot_internal_parity.md)에 기록. Activation bit parity와 closed-loop
...
- **one-off probe 정리**: payload variant exploration script는 retained diagnostic surface에서
  제거했다. 재현 가능한 내부 검증 축은 [`n15_07`](n15_07_lerobot_internal_parity.md)의 parity
  scripts로 둔다.
- **중복 smoke 정리**: 단순 checkpoint load smoke script는 제거했다. checkpoint load 검증은
  [`n15_07`](n15_07_lerobot_internal_parity.md)의 internal parity verifier가 담당한다.
