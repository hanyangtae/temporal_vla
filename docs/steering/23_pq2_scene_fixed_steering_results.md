# 23. pq2 — scene 고정·모델 random 조건의 activation steering 유의성 (최종 결과)

> 2026-07-14 작성. 단일 출처: 이 문서 + `outputs/eval/robocasa/groot_n15/steer_eval_pq2/aggregate_v2/`
...
0.07은 병기(진단 전용)한다. **기준 변경이 pq2 steering 판정을 바꾸는지** 신규 apple 3 cell에서
