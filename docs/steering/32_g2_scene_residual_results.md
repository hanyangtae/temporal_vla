...
## 4.6 2-cell 최종 판정 — exp5-3 정답지 통계량 (2026-07-27 저녁 추가)
...
**판정: G2 통과 (2-cell).** exp5-3 정답지 기준(drawer L12 부호 ≥12/13 & AUROC ≥0.85 유지)을
drawer 는 상회(0.921·13/13), mixer L12 는 유지(0.737→0.741). mixer L2 만 감쇠(0.79→0.70,
p=0.01 잔존) — 얕은 층에선 outcome 상관 분산 일부가 scene between 부분공간과 겹친다는 신호.
결론: **succ/fail 축은 scene(암기) 성분을 걷어낸 뒤에도 살아남는다 — task 2종 공통.**
(유보: 읽힘≠밀림 — §4.5. mixer 는 결정론 경계 민감·SR 예상치 2배 이슈도 §7 그쪽 문서 참조.)
