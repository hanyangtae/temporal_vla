...
\begin{figure}[!t]
  ...
  \caption{\new{군집 수 $k$에 대한 판독 강건성. 사람 phase 수(3--6, 회색 대역)를 넘는
  $k \ge 8$에서 성능이 평평해진다(정확도 0.86--0.89). 옅은 선 = instruction 10개.}}
  \label{fig:ksweep}
\end{figure}
\section{서 론}
