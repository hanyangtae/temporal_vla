...
볼 수 있는 정보를 모두 합친 가장 강한 외부 대조군(행동+시간)이 0.77이다. macro-F1에서는
격차가 더 벌어져 0.72(probe) 대 0.56(행동+시간)으로, 드물게 나타나는 phase일수록 차이가
크다. 같은 지도 조건에서 비교하면 activation probe가 외부 대조군을 10개 instruction 중
