...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=0.30\textwidth]{figs/fig1a_only.pdf}
  \caption{Cluster$\times$GT \term{phase} contingency(PPCC candle, k=8). 최빈 \term{phase}로 행을 정렬하면 블록-대각 구조가 나타난다.}
  \label{fig:purity}
\end{figure*}
\section{서 론}
