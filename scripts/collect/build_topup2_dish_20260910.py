...
base=CollectionPlan.load(repo/'configs/collect/n15_topup2_ppcc_20260910/collection_plan.json')
...
plan.name='n15_topup2_dish_20260910';plan.note='Canonical 1800 + PPCC250 preserved; only new remaining kitchens collected.'
...
out=repo/'configs/collect/n15_topup2_dish_20260910';plan.save(out)
