...
base=CollectionPlan.load(repo/'configs/collect/n15_topup_remaining_20260909/collection_plan.json')
...
plan.name='n15_topup_drawer_20260909';plan.note='Canonical 1800 + PPCC250 preserved; only new remaining kitchens collected.'
...
out=repo/'configs/collect/n15_topup_drawer_20260909';plan.save(out)
