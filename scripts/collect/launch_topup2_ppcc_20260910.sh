...
export PLAN_JSON="$REPO/configs/collect/n15_topup2_ppcc_20260910/collection_plan.json"
export GRID_ROOT="$MAIN_ROOT/outputs/collect/grid_staging_topup2_ppcc_20260910_${COLLECTION_SHARD}"
...
cat "$REPO/configs/collect/n15_topup2_ppcc_20260910/skip_existing.txt" > "$DONE_LIST"
