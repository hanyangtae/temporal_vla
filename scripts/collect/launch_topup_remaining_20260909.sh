...
export PLAN_JSON="$REPO/configs/collect/n15_topup_remaining_20260909/collection_plan.json"
export GRID_ROOT="$MAIN_ROOT/outputs/collect/grid_staging_topup_remaining_20260909_${COLLECTION_SHARD}"
export SERVES_PER_GPU=6 PORT_BASE=9560 NOISE_LIMIT=10
...
cat "$REPO/configs/collect/n15_topup_remaining_20260909/skip_existing.txt" > "$DONE_LIST"
