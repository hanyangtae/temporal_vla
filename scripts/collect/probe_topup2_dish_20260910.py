...
p=str(repo/'configs/collect/n15_topup2_dish_20260910/collection_plan.json');plan=CollectionPlan.load(p)
new=set((repo/'configs/collect/n15_topup2_dish_20260910/new_cells.txt').read_text().splitlines());keys=args.keys.split(',')
