...
p=str(repo/'configs/collect/n15_topup_remaining_20260909/collection_plan.json');plan=CollectionPlan.load(p)
new=set((repo/'configs/collect/n15_topup_remaining_20260909/new_cells.txt').read_text().splitlines());keys=args.keys.split(',')
