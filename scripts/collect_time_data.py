...
XVLA 모델로 LIBERO 환경에서 평가를 실행하고,
각 에피소드의 완료 시간을 기록합니다.

이 데이터는 나중에 Time-Aware XVLA 학습에 사용됩니다.

Usage:
    python scripts/collect_time_data.py \
        --task libero_10 \
        --n_episodes 10 \
        --output data/time_data/libero_10_times.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Collect time data from XVLA evaluation")
    ...
    parser.add_argument("--fps", type=float, default=30.0, help="Environment FPS")
