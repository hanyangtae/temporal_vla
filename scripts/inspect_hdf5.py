...
hdf5_path = "/home/rudxo/workspace/vla_tset/data/datasets/libero_goal/open_the_middle_drawer_of_the_cabinet_demo.hdf5"

if os.path.exists(hdf5_path):
    with h5py.File(hdf5_path, 'r') as f:
        print("Keys in root:", list(f.keys()))
        data = f['data']
        print("Keys in data:", list(data.keys())[:2]) # Print first 2 demos
