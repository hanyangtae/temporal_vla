...
library or RoboCasa SAFE feature server. It may contain N1.5-specific eval and
feature collection clients that reuse the common HTTP and SAFE artifact
contracts.

Current domains:

- `robocasa/`: N1.5 RoboCasa eval clients, HTTP feature collection client, split
  helpers, and checkpoint/runtime compatibility helpers.
...
Do not add loader/schema/IO/serving/feature-extractor library code here. If N1.5
