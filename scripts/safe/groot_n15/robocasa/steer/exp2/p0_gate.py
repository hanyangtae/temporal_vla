...
라벨 출처: 로컬 수집 cell = pkl 파일명 succ 플래그 / srv50(구 w2/worker2) 수집 cell = manifest_w2.txt 파일명
...
def main():
    ...
    ap.add_argument("--out", default="outputs/eval/robocasa/groot_n15/exp2_analysis/p0_gate_report.json")
    args = ap.parse_args()
    rows = []
