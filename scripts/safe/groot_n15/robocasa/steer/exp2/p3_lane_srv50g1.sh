...
# usage: p3_lane_srv50g1.sh <LANE> <P1> <P2> <P3port>
set -u
...
echo "[$LANE] p3 srv50-gpu1 start ports=$W_P1,$W_P2,$W_P3 $(date -u '+%FT%T')"
...
ARM_TAG=${F[TAG]} STEER_MODE=${F[MODE]} EP0=60 EP1=119 OUT_TIER=p3 GPUS_L='1 1 1' PORTS_L='$W_P1 $W_P2 $W_P3' $STEER_ENV \
