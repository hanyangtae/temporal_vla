#!/usr/bin/env python3
"""exp3(구 pq3) β 선택 판정 (계획서 v9 §D β sweep).
...
def main() -> None:
    ...
    ap.add_argument("--sweep-root", required=True, help="steer_eval_exp3/sweep 루트")
    ap.add_argument("--manifest-dir", required=True, help="make_exp3_manifests --out-dir")
