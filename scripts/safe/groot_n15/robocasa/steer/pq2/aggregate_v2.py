...
사용: python scripts/safe/groot_n15/robocasa/steer/pq2/aggregate_v2.py [--out-dir ...]
w2(.50) arm 은 dual_scoring.tsv + ARM_SPEC.json 만 로컬 트리로 pull 해 두면 집계에 포함된다.
"""
import argparse
import csv
import glob
...
def main():
    ...
    ap.add_argument("--p3-root", default=os.path.join(G15, "steer_eval_pq2/p3"))
    ...
    ap.add_argument("--out-dir", default=os.path.join(G15, "steer_eval_pq2/aggregate_v2"))
