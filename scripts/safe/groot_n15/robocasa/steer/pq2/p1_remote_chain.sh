...
G=scripts/safe/groot_n15/robocasa/steer/pq2/make_fit_manifests.py
B=outputs/eval/robocasa/groot_n15/phase_event_6p/raw_rollouts
M=outputs/eval/robocasa/groot_n15/pq2_manifests
...
PYBIN="$PYBIN" JOBS=1 OMP_NUM_THREADS=4 bash scripts/safe/groot_n15/robocasa/steer/pq2/p1_screen.sh $MFS || exit 1
...
"$PYBIN" scripts/safe/groot_n15/robocasa/steer/pq2/p1_candidates.py \
  --out outputs/eval/robocasa/groot_n15/pq2_analysis/p1_candidates_full.json $STEMS
