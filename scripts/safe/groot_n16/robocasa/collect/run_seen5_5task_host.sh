#!/usr/bin/env bash
# Collect GR00T N1.6 RoboCasa rollouts for SAFE on a small 6-task set.
...
RUN_ID="${RUN_ID:-seen6_safe_flow_features_smoke}"
OUT_ROOT="${OUT_ROOT:-${REPO_ROOT}/outputs/eval/robocasa/groot_n16/rollouts_${RUN_ID}}"
OUT_ROOT_CONTAINER="${OUT_ROOT_CONTAINER:-${CONTAINER_REPO_ROOT}/outputs/eval/robocasa/groot_n16/rollouts_${RUN_ID}}"
